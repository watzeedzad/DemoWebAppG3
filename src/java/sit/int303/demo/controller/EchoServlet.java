...
public class EchoServlet extends HttpServlet {
    ...
    @Override
    public void destroy() {
        System.out.println("I am death on " + new java.util.Date()); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public void init() throws ServletException {
        String tmp = getInitParameter(color1);
        if (tmp != null) {
            color1 = tmp;
        }
        tmp = getInitParameter(color2);
        if (tmp != null) {
            color2 = tmp;
        }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<body style=\"background-color:" + color1 + ";color:\""+color2+"\"\"><h2>You have enter</h2>");
